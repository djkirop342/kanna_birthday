...
$('document').ready(function(){
	...
	function wishMessage() {
		...
		$("#wish_message").fadeOut('slow').delay(3000).promise().done(function(){
			// $('#story').fadeIn('slow');
			story()
		});
	}
				...
				if(i == 32) {
					$("p:nth-child(31)").fadeOut('slow').promise().done(function () {
						...
						setTimeout(function() {
							...
							$(".balloons-rotate-behaviour-one").css("display", "none")
							$(".balloons-rotate-behaviour-two").css("display", "none")
